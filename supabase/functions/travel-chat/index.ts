...
- Для передачи в WhatsApp формируй ссылку: https://wa.me/77001234567?text=ТЕКСТ где ТЕКСТ — краткое резюме запроса клиента (направление, даты, бюджет, количество гостей)
